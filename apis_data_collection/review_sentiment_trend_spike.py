import pandas as pd
from notifications.Notification import send_mail
...
SPIKE_THRESHOLD =  0.3        # 0.5-0.7  = -0.2 (considered)
...
send_mail(subject="Sentiment Spike and Trend Shift Notification", text="Please find the attached file of sentiment analysis and trend shify of Reviews data", df=alert_df)
